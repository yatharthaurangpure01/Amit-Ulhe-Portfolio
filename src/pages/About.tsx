            ...
            <section className="section-padding bg-background">
                <div className="container-custom">
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
                        <div>
                            <div className="aspect-[5/5] rounded-2xl overflow-hidden shadow-strong">
                                <img
                                    src="/AmitUlhe.JPG"
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-muted-foreground text-lg leading-relaxed">
                                I'm an Authorized Financial Planner & Insurance Advisor specializing in Child Funds Creation Planning and Retirement Planning. My mission is to help individuals and families achieve their financial goals, security, and peace of mind.
                            </p>
                            <p className="text-muted-foreground text-lg leading-relaxed">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="lg:order-2 order-1">
                            <div className="aspect-[5/5] overflow-hidden max-md:shadow-strong">
                                <img
                                    src="/BhavnaUlhe.jpeg"
                                    alt="Bhavna Amit Ulhe - Financial Planner & Advisor"
                                    className="md:w-[80%] h-full rounded-2xl object-cover object-top"
                                />
                            </div>
                        </div>
                    </div>
